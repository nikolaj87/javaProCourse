package main.java.javasummary.lesson19_05;
...
//    убедитесь, что файл существует, удалите файл.
    ...
    public static void task2() {
        File file2 = new File("C:\\Users\\Slonick\\IdeaProjects\\javaProCourse" +
                "\\src\\main.java.javasummary\\lesson19_05\\2.txt");
        try {
            file2.createNewFile();
        }
        catch (IOException e) {
    ...
    public static String readFile() {
        try (FileReader fr = new FileReader("src/main.java.javasummary/lesson19_05/1.txt");
    ...
    public static void createFile(String str) {
        ...
        try (FileOutputStream fos = new FileOutputStream("src/main.java.javasummary/lesson19_05/1.txt")) {
